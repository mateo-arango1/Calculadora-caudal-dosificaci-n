...
# =====================================================================
    ...
    ppm_jarra_1 = col_dosis[0].number_input('Jarra 1 (ppm):', min_value=0.0, value=100.0, format="%.2f", key='ppm_j1')
    ppm_jarra_2 = col_dosis[1].number_input('Jarra 2 (ppm):', min_value=0.0, value=120.0, format="%.2f", key='ppm_j2')
    ppm_jarra_3 = col_dosis[2].number_input('Jarra 3 (ppm):', min_value=0.0, value=140.0, format="%.2f", key='ppm_j3')
    ppm_jarra_4 = col_dosis[3].number_input('Jarra 4 (ppm):', min_value=0.0, value=160.0, format="%.2f", key='ppm_j4')
        ...
        if S_jarra > 0 and Vol_jarra_L > 0:
            ...
            if denominador == 0:
                ...
                for i, (label, ml) in enumerate(resultados.items()):
                    ...
                    cols[i].metric(label=label, value=f"{ml:.2f} mL")
